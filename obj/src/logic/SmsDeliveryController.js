...
const SmsDeliveryCommandSet_1 = require("./SmsDeliveryCommandSet");
class SmsDeliveryController {
    constructor() {
    ...
    configure(config) {
        this._config = config.setDefaults(SmsDeliveryController._defaultConfig);
    ...
    getCommandSet() {
        if (this._commandSet == null)
            this._commandSet = new SmsDeliveryCommandSet_1.SmsDeliveryCommandSet(this);
...
SmsDeliveryController._defaultConfig = pip_services_commons_node_1.ConfigParams.fromTuples('message.from', null, 'options.connect_timeout', 30000, 'options.max_price', 0.5, 'options.sms_type', 'Promotional');
exports.SmsDeliveryController = SmsDeliveryController;
//# sourceMappingURL=SmsDeliveryController.js.map