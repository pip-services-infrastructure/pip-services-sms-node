...
class SmsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
SmsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-sms", "factory", "default", "default", "1.0");
SmsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sms", "controller", "default", "*", "1.0");
SmsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sms", "service", "seneca", "*", "1.0");
SmsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-sms", "service", "http", "*", "1.0");
