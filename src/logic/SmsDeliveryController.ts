...
import { SmsDeliveryCommandSet } from './SmsDeliveryCommandSet';

export class SmsDeliveryController implements IConfigurable, IReferenceable, ICommandable, IOpenable, ISmsDeliveryController {
    ...
    private _commandSet: SmsDeliveryCommandSet;
    ...
    public getCommandSet(): CommandSet {
        if (this._commandSet == null)
            this._commandSet = new SmsDeliveryCommandSet(this);
